	...
	<body>
		...
		<aside id="sidebar">
			...
			<div id='menu'>
				<ul>
					<!--<li>
						<a href='profileLect.jsp'>before this is index.html
					...
					<li class='has-sub highlight active'>
						...
						<ul style="display: block">
							...
							<li>
								<a href='FormBookingLab.jsp' >
									<span>Lab</span>
								</a>
							</li>
                                                </ul>	
                                        <li>
						<a href='LectLogout.jsp'>
						...
						<div class="row">
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div class="blog">
									...
									<div class="blog-body">
  <form action="editBooking" id="bookingForm" method="post">
											<div class="form-group">
												<div class="row">
                                                                                                    ${errorString1}
													<div class="col-md-8">
														<label class="control-label">Booking ID</label>
														<input type="text" class="form-control"  value="${product.booking_id}" name="id" disabled /> 
													</div>
                                                                                                        <div class="col-md-8">
														<label class="control-label">Start Date </label>
														<input type="date" class="form-control" id="Sdate" value="${product.startDate}" name="startDate" />
													</div>
                                                                                                        <div class="col-md-8">
														<label class="control-label">Time start</label>
														<input type="time" class="form-control" id="sTime" value="${product.starttime}" name="startTime" />
													</div>
                                                                                                        <div class="col-md-8">
														<label class="control-label">End Date</label>
														<input type="date" class="form-control" id="Edate" value="${product.endDate}" name="endDate" />
													</div>
                                                                                                        <div class="col-md-8">
														<label class="control-label">Time end</label>
														<input type="time" class="form-control" id="eTime" value="${product.endtime}" name="endTime" />
													</div>
                                                                                                        <div class="col-md-8">
														<label class="control-label">Status</label>
														<input type="text" class="form-control"  value="${product.status}" name="status" disabled />
													</div>
												...
												<div class="row">
													<div class="col-md-4 selectContainer">
														...
														<select class="form-control" id="book" name="book">
                                                                                                                        <option value="${product.book}">${product.book}</option>
